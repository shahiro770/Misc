 ...
 * 2017-11-26
 *
 * This program activates the client side of the program.
...
int main(int argc, char	*argv[]) {
	char buffer[10000];				//store input
	char serverOut[10000];			//store output from server
	...
	while(1){	
		...
		printf("\nEnter shell command: ");		//enter shell commands
		scanf("%s", buffer);
